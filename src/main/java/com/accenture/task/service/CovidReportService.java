...
public class CovidReportService {
    ...
    public float getCorrelationCoefficientForAllCountries(String allCountries) {
        Map<String, Object> vaccinationData = getCovidData(CovidConstants.ALL_COUNTRIES_VACCINE_URL);
        Map<String, Object> covidDeathsData = getCovidData(CovidConstants.ALL_COUNTRIES_COVID_CASES_URL);
    ...
    public float getCorrelationCoefficientForContinent(String continent) {
        Map<String, Object> vaccinationData = getCovidData(CovidConstants.CONTINENT_VACCINE_URL + continent);
        Map<String, Object> covidDeathsData = getCovidData(CovidConstants.CONTINENT_COVID_CASES_URL + continent);
